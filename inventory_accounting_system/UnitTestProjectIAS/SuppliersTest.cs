    ...
    public class SuppliersTest {
        ...
        public void SupplierDelete () {
            ...
            using (var _context = new ApplicationDbContext (options)) {
                ...
                SuppliersController controller = new SuppliersController (_context);
             
                Task<IActionResult> result1 = controller.DeleteConfirmed (vendor.Id);
                var supSearch = _context.Suppliers.SingleOrDefault (a => a.Id == vendor.Id);

                Assert.NotNull (result1);
                Assert.Equal (supSearch, null);
            }
        }
